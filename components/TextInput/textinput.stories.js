...
var CustomSuggestionsTextInput = function (_Component3) {
  ...
  function CustomSuggestionsTextInput() {
    ...
    return _ret3 = (_temp3 = (_this3 = _possibleConstructorReturn(this, _Component3.call.apply(_Component3, [this].concat(args))), _this3), _this3.state = { value: '', suggestionOpen: false }, _this3.boxRef = (0, _react.createRef)(), _this3.onChange = function (event) {
