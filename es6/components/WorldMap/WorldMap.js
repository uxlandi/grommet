  ...
  WorldMap.prototype.render = function render() {
    ...
    var continents = Object.keys(continentStates).map(function (name) {
      ...
      return React.createElement(
        ...
        React.createElement('path', { stroke: 'none', fill: '#fff', fillOpacity: '0.01', d: area }),
...
var WorldMapWrapper = compose(withTheme)(process.env.NODE_ENV !== 'production' ? doc(WorldMap) : WorldMap);
